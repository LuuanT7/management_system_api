...
exports.DeleteEnrollmentUseCase = void 0;
const tsyringe_1 = require("tsyringe");
const AppError_1 = require("@shared/errors/AppError");
const zod_1 = require("zod");
const deleteEnrollmentSchema = zod_1.z.object({
    id: zod_1.z.string({
...
let DeleteEnrollmentUseCase = class DeleteEnrollmentUseCase {
    ...
    async execute(id) {
        try {
            ...
            throw new AppError_1.AppError("Erro ao deletar matrícula (DeleteEnrollmentUseCase)", 500);
        }
    }
};
exports.DeleteEnrollmentUseCase = DeleteEnrollmentUseCase;
exports.DeleteEnrollmentUseCase = DeleteEnrollmentUseCase = __decorate([
